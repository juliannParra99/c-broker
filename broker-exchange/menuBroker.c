...
void modificarEmpresa()
{
    ...
    // Limpiar el buffer de entrada después de leer el Id Ticker
    getchar();
    ...
    for (int i = 0; i < numEmpresas; i++) {
        if (strcmp(listaEmpresas[i].id_ticker, id_ticker) == 0) {
            ...
            // Modificar el precio actual de la empresa con validación
            float nuevoPrecio;
            do {
            ...
            } while (nuevoPrecio < 0);  // Asegurarse de que el precio sea válido
